               ...
               <hr />
                ...
                <div className="row mt-2 mb-5">
                  <div className="rating w-50">
                    <div className="modal fade" id="ratingnModal" tabIndex="-1" role="dialog"
                     ...
                     <div className='modal-dialog' role="document">
                      <div className='modal-content'>
                        ...
                        <div className='modal-body'>
                          ...
                          <textarea name ="reviw" id="review" className='from-control mt3'></textarea>
                          <button className='bt my-3 float-right review-btn px-4 text-white'
                          data-dismiss="modal" aria-laberl="Close">Enviar</button> 
                        </div>
                      </div>
                     </div>
                    </div>
